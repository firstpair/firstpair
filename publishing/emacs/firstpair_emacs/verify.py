...
def verify_bundle(root: Path, *, run_emacs: bool = True, run_makeinfo: bool = True) -> dict[str, object]:
    ...
    for required in ("init.el", "dir", "Guide.md", "README.md", "data/reader.json", "data/records.json", "data/references.json", "data/marked.tsv", "lisp/firstpair-bundle.el", "lisp/firstpair-lexicon.el", "lisp/firstpair-reader.el"):
