...
def _lexicon_guide(config: EmacsConfig, corpus_spec) -> str:
    ...
    return (
        ...
        "replaces the introductory references pane, or opens below a cited source that "
        "must remain visible. It shows the dictionary form, the grammatical analysis "
        "of the exact form in front of you, and the senses. "
